...
class arithmeticExpression{
  ...
  public:
    ...
    /*helper function to remove the nodes recursively in the destructor*/
    void clearNodesMemory(TreeNode *node);
 ...
 private:
    ...
    void visualizeTree(ofstream &out, TreeNode *input);
};
#endif