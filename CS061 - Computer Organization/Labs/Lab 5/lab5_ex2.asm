...
ST R7, BACKUP_R7_3200   ; Backup R7 register
...
LD R7, BACKUP_R7_3200   ; Restore R7 register
...
BACKUP_R7_3200  .BLKW #1   ; Space for R7 backup
.END
...
ST R7, BACKUP_R7_3400   ; Backup R7 register
...
LD R7, BACKUP_R7_3400   ; Restore R7 register
RET
...
BACKUP_R7_3400  .BLKW #1   ; Space for R7 backup
.END
