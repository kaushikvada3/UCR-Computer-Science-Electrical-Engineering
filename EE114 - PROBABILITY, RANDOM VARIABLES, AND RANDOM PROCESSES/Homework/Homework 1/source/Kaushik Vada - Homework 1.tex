...
\begin{enumerate}[label=(\alph*)]
    \item Are $T$ and $M$ mutually exclusive? \\[1em]
    ...
    \item Are $R, T,$ and $M$ collectively exhaustive? \\[1em]
    ...
    \item Are $T$ and $O$ mutually exclusive? State this condition in words. \\[1em]
    ...
    \item Does Gerlanda's make Tuscan pizzas with mushrooms and onions? \\[1em]
    ...
    \item Does Gerlanda's make regular pizzas that have neither mushrooms nor onions? \\[1em]
...
\begin{enumerate}[label=(\alph*)]
    \item What are the elements of the sample space of this experiment? \\[1em]
    ...
    \item Are $Z_F$ and $X_A$ mutually exclusive? \\[1em]
    {\boldmath\textbf{The intersection $Z_F \cap X_A = \{aaf, aff\}$. Since it is not empty: No.}}
    
    \item Are $Z_F$ and $X_A$ collectively exhaustive? \\[1em]
...
\noindent
\noindent
What is the probability $P[H_0]$ that a phone makes no handoffs? \\[1em]
{\boldmath\textbf{$P[H_0] = 0.1 + 0.4 = 0.5$}}

\noindent
What is the probability a call is brief? \\[1em]
{\boldmath\textbf{$P[B] = 0.4 + 0.1 + 0.1 = 0.6$}}

\noindent
What is the probability a call is long or there are at least two handoffs? \\[1em]
...
\begin{enumerate}[label=(\alph*)]
    \item Classify a call as long, $L$, if the call lasts more than three minutes. What is $P[L]$? \\[1em]
    {\boldmath\textbf{$P[L] = P[M \ge 4] = \sum_{m=4}^\infty \alpha(1-\alpha)^{m-1} = (1-\alpha)^3 = (0.57^{1/3})^3 = 0.57$}}
    
    \item What is the probability that a call will be billed for nine minutes or less? \\[1em]
...
\noindent \vspace{1em} {\boldmath\textbf{Base case (n=2): $P[A_1 \cup A_2] = P[A_1] + P[A_2] - P[A_1 \cap A_2] \le P[A_1] + P[A_2]$.}} \\
