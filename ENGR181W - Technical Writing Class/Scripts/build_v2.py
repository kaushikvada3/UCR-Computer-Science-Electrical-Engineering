...
lc.body(
    ...
    'P42A pack. The prototype ran in a controlled lab at UC Riverside. A '
    'commercial version would not.')
lc.body(
...
lc.body(
    'Lithium battery fires killed more than a dozen people in New York City '
    'in a single year, which produced emergency legislation requiring UL '
...
lc.body(
    ...
    'within 70 ms with no software involvement, since firmware-dependent '
    ...
    'conditions. That swap happened under time and budget pressure. It is '
    'exactly the kind of decision the IEEE Code of Ethics points at: public '
    'safety comes before convenience [6].')
lc.body(
    'Open architecture is also an ethical choice in this context. The '
    'first-run prototype cost about $2,966 including development hardware. '
...
rc.body(
    'The biggest lesson was designing for failure. The IEEE Code of Ethics '
...
rc.body(
    'The second lesson was harder: being honest when the numbers did not '
    'come out right. Post-production routing errors in the E-Load PCB made '
...
rc.body(
    ...
    'public safety as the first constraint in the design, not something to '
    'satisfy after the product is already designed.')
...
doc.save('Ethics_Impact_Essay_v2_fixed.docx')
print('Saved Ethics_Impact_Essay_v2_fixed.docx')
